[
  // これから実施されるボランティア（未来2件）
  {
    ...
    locationImageUrl: "https://maps.googleapis.com/maps/api/staticmap?center=大阪市北区茶屋町&zoom=15&size=400x400&key=YOUR_API_KEY",
  ...
  },
  {
    ...
    location: "大阪府大阪市北区中津",
    locationImageUrl: "https://maps.googleapis.com/maps/api/staticmap?center=大阪市北区中津&zoom=15&size=400x400&key=YOUR_API_KEY",
  ...
  // すでに終了したボランティア（過去2件）
  {
    ...
    location: "大阪府大阪市北区梅田",
    locationImageUrl: "https://maps.googleapis.com/maps/api/staticmap?center=大阪市北区梅田&zoom=15&size=400x400&key=YOUR_API_KEY",
  ...
  },
  {
    ...
    location: "大阪府大阪市北区扇町",
    locationImageUrl: "https://maps.googleapis.com/maps/api/staticmap?center=大阪市北区扇町&zoom=15&size=400x400&key=YOUR_API_KEY",
