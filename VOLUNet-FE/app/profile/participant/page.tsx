...
import { ArrowLeft, Edit3, Star, Calendar, MapPin, Users, QrCode } from "lucide-react"
      ...
      <main className="px-6 py-8">
        <div className="max-w-4xl mx-auto">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-slate-500">({user.reviewCount}件の評価)</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-lg font-semibold text-slate-700">{user.participationCount}</span>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-lg">
            <h2 className="text-2xl font-bold text-slate-900 mb-6">参加したボランティア活動</h2>
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          {activity.rating && (
                            <div className="flex items-center space-x-1">
                              <span className="text-xs text-slate-500">あなたの評価:</span>
                              <div className="flex items-center">
                                {[...Array(5)].map((_, i) => (
                                  <Star
                                    key={i}
                        ...
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-medium ${
                            activity.status === "完了" ? "bg-green-100 text-green-700" : "bg-blue-100 text-blue-700"
                          }`}
                        >
                          {activity.status}
                        </span>
            ...
            {participatedActivities.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-slate-700 mb-2">まだボランティア活動に参加していません</h3>
                <p className="text-slate-500 mb-6">新しいボランティア活動に参加してみましょう</p>
                <Link href="/student">
