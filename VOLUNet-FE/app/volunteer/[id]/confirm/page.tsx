...
export default function ConfirmPage({ params }: ConfirmPageProps) {
  ...
  // サンプルデータ（実際は params.id を使ってデータを取得）
  ...
  const handleApply = () => {
    // ここに応募処理を実装
    router.push(`/volunteer/${params.id}/complete`)
  }
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-lg">
              <h2 className="text-xl font-bold text-slate-900 mb-4">ボランティア情報</h2>
              <div className="bg-slate-50 p-6 rounded-xl">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">{volunteerActivity.title}</h3>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-lg">
              <h2 className="text-xl font-bold text-slate-900 mb-4">参加規約</h2>
              <div className="bg-slate-50 p-6 rounded-xl mb-6 max-h-80 overflow-y-auto">
                <div className="text-slate-700 space-y-4">
                  <p>1. 参加者は、活動日時・場所を確認し、時間厳守でご参加ください。</p>
                  <p>2. 活動中は主催者の指示に従い、安全に配慮して行動してください。</p>
                  <p>3. 体調不良や急な予定変更で参加できなくなった場合は、速やかに主催者へご連絡ください。</p>
                  <p>4. 活動中の事故やケガについては、原則として自己責任となります。</p>
                  <p>5. 活動中に撮影された写真等は、VOLUNetの広報活動で使用される場合があります。</p>
                  <p>6. 個人情報は活動に関する連絡以外の目的で使用されることはありません。</p>
                  <p>7. 参加者は互いに尊重し合い、ハラスメント行為は一切禁止します。</p>
                  <p>8. 主催者が不適切と判断した場合、参加をお断りすることがあります。</p>
                  <p>9. 活動内容や開催状況は、天候や諸事情により変更・中止となる場合があります。</p>
